...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('auth/users/reset_password/', formData);
      ...
      <div className="w-full max-w-md bg-gray-800 rounded-2xl shadow-xl p-8">
        ...
        {submitSuccess && (
          <div className="mb-6 p-4 bg-green-900 border border-green-700 rounded-lg">
            <p className="text-green-200 text-sm">Password reset email sent! Please check your inbox.</p>
          </div>
        )}
